...
- **Clock in Method**: Indicates whether a buddy is using **Face recognition** or **Face recognition + ID card** to clock-in or clock-out. Users can modify the method by clicking on the **three-dot menu** and selecting **Function settings**.
